...
export const siteMeta = {
  ...
  announcement: "New cohort enrolling — limited seats · India AI Learning Tour 2026",
  mascotGreeting: "Hi, I'm Marut, Welcome to OranjeStride!"
};
...
export const aboutData = {
  ...
  principles: [
    {
      n: "01",
      h: "Relevance With Industry",
      p: "Curriculum crafted by practitioners mapped to real job roles in AI, Data Engineering, and Analytics."
    },
    {
      n: "02",
      h: "Expert Experienced Faculty",
      p: "Dedicated data scientists and educators with hundreds of hours of live training delivery across elite institutions."
    },
    {
      n: "03",
      h: "Analytics For All",
      p: "Case-study methodology ensuring participants from finance, ops, and HR grasp practical applications immediately."
    },
    {
      n: "04",
      h: "Certified Analytics Professional",
      p: "Our OAP certification helps professionals stand apart in a crowded talent market."
    }
  ] as PrincipleItem[]
};
...
export const expertiseData = {
  ...
  cards: [
    {
      prop: "brain",
      h: "Generative AI & Agentic AI",
      p: "LLMs, prompt engineering, RAG architectures, AI agents, autonomous workflows.",
      tags: ["LLMs", "RAG", "Agents", "Prompt Eng."]
    },
    {
      prop: "chip",
      h: "Machine Learning & Statistical Modeling",
      p: "Supervised & unsupervised learning, regression, classification, ensemble methods, interpretability.",
      tags: ["Scikit-learn", "XGBoost", "Python/R", "Stats"]
    },
    {
      prop: "gem",
      h: "Data Science & Advanced Analytics",
      p: "End-to-end pipelines, EDA, feature engineering, fraud detection, risk scoring, forecasting.",
      tags: ["Pandas", "SQL", "Forecasting", "A/B Testing"]
    },
    {
      prop: "chart",
      h: "Business Intelligence & Visualization",
      p: "Tableau, Power BI, Python viz labs, executive dashboards.",
      tags: ["Tableau", "Power BI", "Plotly", "Dashboards"]
    },
    {
      prop: "arrow",
      h: "Corporate & Executive AI Strategy",
      p: "Workshops for C-suite on AI adoption, ROI mapping, transformation roadmaps.",
      tags: ["Strategy", "AI Roadmap", "Change Mgmt"]
    },
    {
      prop: "node",
      h: "Deep Learning & Neural Networks",
      p: "CNNs, RNNs, Transformers, computer vision.",
      tags: ["TensorFlow", "PyTorch", "Transformers", "CV"]
    }
  ] as ExpertiseCard[]
};
...
export const testimonialsData = {
  ...
  items: [
    {
      initial: "D",
      quote: "When theoretical concepts go hand in hand with practical implementation, the mind forces itself to explore beyond the vanilla concepts.",
      name: "Dilpreet",
      org: "Sopra Steria"
    },
    {
      initial: "A",
      quote: "One of the best teachers I have ever had... you make difficult things easy to understand.",
      name: "Ashish Aggarwal",
      org: "Shri Vishwakarma Skill University"
    },
    {
      initial: "L",
      quote: "A great hands-on introduction to ML... The R & Python coverage is exceptional and immediately actionable.",
      name: "Lakshay Guglani",
      org: "Maharaja Agrasen College of Engg."
    }
  ] as TestimonialItem[]
};

export const mascotLabData = {
  ...
  tabs: [
    {
      ...
      steps: [
        {
          h: "Sector Tracks",
          p: "Banking & Financial Services (Credit Risk, Fraud ML, Forecasting, Gen AI), Healthcare & Pharma, Insurance (Claims AI, Churn, Risk Pricing), FMCG & Retail (Demand Forecast, CLV, Supply Chain AI), Government & Public Sector, Media/Tech/Telecom."
        },
        {
          h: "Leadership Tracks",
          p: "AI for Leaders — Strategic Fluency (flagship); AI Adoption Roadmap Workshop; Executive Analytics for Decision-Makers; Strategic Innovation with AI."
        },
        {
          h: "Generative AI & Agentic AI Bootcamp",
          flagship: true,
          p: "LLMs, RAG, Prompt Engineering, MCP, Deployment."
        }
      ]
    },
    {
      ...
      steps: [
        {
          h: "Undergraduate Track",
          p: "Data Analytics for Undergraduates (Excel → MySQL → Tableau/Power BI → Python → Business Stats → capstone).",
          cert: true
        },
        {
          h: "Postgraduate / MBA Track",
          p: "Business Analytics & ML for Managers (Python, regression, ML, credit/churn/revenue modelling, capstone).",
          cert: true
        },
        {
          h: "Generative AI & Agentic AI Bootcamp",
          flagship: true,
          p: "LLMs, RAG, Prompt Engineering, MCP, Deployment — for UG/PG cohorts."
        }
      ]
    }
  ] as ProgrammeTab[]
...
export const consultingData = {
  ...
  items: [
    {
      prop: "chart",
      h: "Quant Research & Risk Analytics",
      p: "Statistical modeling, factor analysis, risk scoring, backtesting → portfolio analytics."
    },
    {
      prop: "chip",
      h: "Financial Forecasting & Fraud Detection",
      p: "ML fraud detection, credit risk models, forecasting pipelines."
    },
    {
      prop: "node",
      h: "Government & Policy Research Analytics",
      p: "Analytics roadmaps, data governance, policy impact modeling."
    }
  ] as ConsultingItem[],
...
export const indiaTourData = {
  ...
  features: [
    {
      h: "Come to India. Learn at the Source.",
      p: "Structured, immersive programme on a partner university campus or executive training facility."
    },
    {
      h: "Practitioner-Led Curriculum",
      p: "OranjeStride faculty with live corporate experience (Accenture, EXL Services, global financial institutions). No pre-recorded content."
    },
    {
      h: "Hands-On Labs & Real Projects",
      p: "Real datasets from participants' own sectors (banking, insurance, government, FMCG); leave with deployable code/dashboards."
    },
    {
      h: "Cultural Immersion + Networking",
      p: "Campus visits, industry interfaces, peer cohorts from across the globe."
    },
    {
      h: "University-Backed Certificate",
      p: "Jointly signed by OranjeStride & a university of repute in India."
    }
  ] as TourFeature[]
};
...
export const dataStrideData = {
  ...
  ] as DataStrideFeature[],
  url: "https://datastride.oranjestride.com/"
};
